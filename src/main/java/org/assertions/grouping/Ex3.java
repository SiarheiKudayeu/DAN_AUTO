package org.assertions.grouping;
...
public class Ex3  extends BaseTest {
    ...
    public void NoResultButtonIsDisplayed() {
        ...
        assertEquals(driver.findElement(Locators.titleSearchText).getText(),
                resultText);
        assertTrue(driver.findElement(Locators.noResultButton).isDisplayed());
        assertEquals(driver.findElement(Locators.noResultButton).getText(),"Результатів немає");
    }
